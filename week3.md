...
<img width="934" height="758" alt="DE522AA1-E390-4C05-AB7D-9150973CA537" src="https://github.com/user-attachments/assets/f182de34-5d71-4d4b-8db2-096581179017" />

- **수행 기준**
    - 최소 1회 슬랙에 공유하기

### 3️⃣ 나와 비슷한 성향의 "한국" 개발자 멘토 추천 받기
가끔은 멀리 내다보는 것도 중요하잖아요?  
바쁘게 코딩하다 문득 고개를 들어볼 때,  
먼저 이 길을 멋지게 걸어온 선배가 있다면 더 든든하지 않을까요? 😊  

나랑 비슷한 성향, 비슷한 분야에서 성장한  
나만의 개발자 롤모델을 이번 기회에 찾아보세요! ✨  
...
## 💖 퀘스트 수행
### J111_박세윤
**2️⃣ 자신의 성향을 프롬프트로 입력하고, 노래 만들기**   

선택한 이유:  
텍스트 생성이나, 이미지 생성은 자주 사용해봤지만, AI로 노래를 만들어본 경험이 없어서 재밌게 수행할 수 있을 것 같고, 힘든 미션 중에 위로가 되는 노래를 만들어볼 수 있을 것 같습니다!  
...
선택한 이유 :   
취업을 준비해보면서 자기소개서를 작성할 때 내가 어떤 스타일의 개발자인지를 어필해야하는 경우가 많았다. 본인을 객관화해서 작성하기 힘들었는데, 이 퀘스트를 통해 내가 어떤 성향인지, 이를 어떻게 보완해나가야하는지 알아봐야겠다고 생각했다.   

### K030_한혜진
**1️⃣ 자신이 프로젝트 파일을 통해 AI에게 개발 성향 물어보기**  

선택한 이유 :  
내가 한 학습정리들을 되돌아볼수도 있고 어떤 유형인지도 궁금해서 택했다  
